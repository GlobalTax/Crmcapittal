/**
 * Operations Optimized Hook
 * 
 * Optimized hook that combines operations data, filtering, and pagination
 */
...
export const useOperationsOptimized = (filters: OperationFilters, pageSize: number = 12) => {
