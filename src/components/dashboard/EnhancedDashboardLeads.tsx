    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Análisis completo del pipeline de leads
          </p>
        </div>
        <Badge className="bg-primary/10 text-primary">
          {kpis.totalLeads} leads activos
        </Badge>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-4">
        <MetricCard
          ...
          change={{ value: `${kpis.newLeads7d} nuevos (7d)`, trend: 'up' }}
          icon={Users}
        />
        ...
        <MetricCard
          ...
          change={{ value: "Score ≥80", trend: 'up' }}
          icon={Flame}
        />
        ...
        <MetricCard
          ...
          change={{ 
            value: kpis.conversionRate >= 20 ? 'Excelente' : 
                   kpis.conversionRate >= 10 ? 'Buena' : 'Mejorar', 
            trend: kpis.conversionRate >= 15 ? 'up' : 'down' 
          }}
          icon={TrendingUp}
        />
        ...
        <MetricCard
          ...
          change={{ value: "Valor cualificado", trend: 'up' }}
          icon={Euro}
        />
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <MetricCard
          ...
          change={{ 
            value: kpis.leadsTrend === 'up' ? 'Tendencia positiva' : 
                   kpis.leadsTrend === 'down' ? 'Tendencia negativa' : 'Estable',
            trend: kpis.leadsTrend === 'up' ? 'up' : 'down'
          }}
          icon={Calendar}
        />
        ...
        <MetricCard
          ...
          change={{ value: "Para cualificar", trend: 'up' }}
          icon={Clock}
        />
      </div>
