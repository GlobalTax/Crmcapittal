...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto">
    <table
      ref={ref}
      className={cn("w-full caption-bottom text-sm border-2 border-black", className)}
      {...props}
    />
  </div>
))
...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    className={cn("[&_tr:last-child]:border-0 [&_tr:not(:last-child)]:border-b [&_tr:not(:last-child)]:border-gray-300", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t-2 border-black bg-gray-100 font-medium [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
