...
export const createSampleOperations = async () => {
  // This function will be called to create the sample operations
  // Using the existing addBulkOperations functionality
  console.log("Creating sample operations...", sampleOperations);
  return sampleOperations;
};

export { sampleOperations };
