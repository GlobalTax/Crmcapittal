...
export const useCases = () => {
  ...
  const createCase = async (data: CreateCaseData) => {
    try {
      // Create insert data excluding case_number (auto-generated by trigger)
      // and other auto-generated fields
      const insertData: Omit<Case, 'id' | 'case_number' | 'created_at' | 'updated_at' | 'contact' | 'company' | 'practice_area' | 'proposal'> = {
        ...data,
