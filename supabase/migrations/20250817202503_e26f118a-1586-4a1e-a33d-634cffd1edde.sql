-- Añadir columna stage_config para almacenar checklist y configuración de etapas
ALTER TABLE pipeline_stages 
ADD COLUMN stage_config JSONB DEFAULT '{}';

-- Actualizar la etapa "Cualificado" con el checklist de QA
