-- FASE 1: INFRASTRUCTURE BASE - Workflows de Automatización
-- =====================================================================
...
-- 4. Función para detectar contactos inactivos
...
BEGIN
  ...
  WHERE c.classification IN ('target', 'inversor')
...
-- 5. Función para detectar inconsistencias contacto-empresa
...
-- 6. Función para crear tareas automáticas de workflow
