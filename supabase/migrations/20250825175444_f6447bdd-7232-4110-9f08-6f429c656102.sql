...
-- Minimal approach: just drop view and alter columns

-- 1. Drop the dependent view (will need manual recreation later)
...
-- 3. Add reasonable constraints to prevent invalid values
ALTER TABLE public.leads 
