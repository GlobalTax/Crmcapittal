-- FASE 1: INFRASTRUCTURE BASE - Workflows de Automatización (Final)
-- =====================================================================
...
-- 8. Función para crear tareas automáticas de workflow (corregida)
...
CREATE INDEX IF NOT EXISTS idx_contact_tasks_status ON contact_tasks(task_status);
...
CREATE INDEX IF NOT EXISTS idx_company_tasks_status ON company_tasks(task_status);
