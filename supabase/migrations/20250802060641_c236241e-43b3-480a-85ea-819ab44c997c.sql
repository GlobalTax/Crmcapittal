...
-- 2. Crear tabla embeddings si no existe (para almacenar vectores de embeddings)
CREATE TABLE IF NOT EXISTS public.embeddings (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  entity_type TEXT NOT NULL, -- 'lead', 'company', 'contact'
  entity_id UUID NOT NULL,
  embedding_data VECTOR(1536), -- OpenAI text-embedding-3-small dimension
...
-- Embeddings: Solo administradores (ya existe la política)
